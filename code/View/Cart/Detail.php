...
?>
<div style="background-color:white;" class="product-big-title-area">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <center>
                        <h2 style="background-color: #FFCCFF;width: 700px; font-weight: bold;color: #990033;font-size: 20px;font-family: Arial;border-radius: 10px;" class="section-title">Chi tiết giỏ hàng</h2></center>
                </div>
            </div>
        </div>
