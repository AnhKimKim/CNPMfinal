<center><h2 style="background-color: #FFCCFF; font-weight: bold;color: #990033;font-size: 30px;font-family: Arial;border-radius: 10px;"><?php echo $manuName["ManufacturerName"]; ?></h2></center>
<hr>
<div class="main-ver2">
