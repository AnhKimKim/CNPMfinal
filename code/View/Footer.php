            ...
            <div class="row">
                <div class="col-md-4 col-sm-12">
                    <div class="footer-about-us">
                        <h2 style="font-family:logo;"><span style="color: #990033;font-size: 50px;">Flower Shop</span></h2>
                       <address>
    ...
    <div class="footer-bottom-area">
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <div class="copyright">
                        <p><a style="color: #ff6600;font-size: 15px" href="index.php" target="_blank">Flower Shop</a></p>
                    </div>
                </div>
                <div class="col-md-4">
