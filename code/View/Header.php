...
EOD;
    ...
    <style>
      @font-face { font-family: logo; src: url('font/UVNBenXuan_B.TTF'); } 
                ...
                <div style="background-color: #FFCCFF; font-weight: bolder;"class="navbar-collapse collapse">
                    <ul type="disc" class="nav navbar-nav">
                        <li><a style="color: #336600; font-family: logo ;font-size:25px;background-color: #FFCCFF"  href="index.php">Flower shop</a></li>
                        <li>
                            <?php include_once("Controller/Products/Search.php") ?>
                        </li>
                        <li><a style="color: #000000" href="index.php?mod=products&act=allproducts" onclick="return isActive()">Sản Phẩm</a></li>
                        ...
                        <li class="dropdown">
                            <a style="color: #000000" href="#" class="dropbtn">Phân Loại</a>
                        ...
                        <li class="dropdown">
                            <a style="color: #000000" href="#" class="dropbtn">Chủ đề</a>
                            <div class="dropdown-content">
